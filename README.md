...
In my case:  
``` bash
sudo apt install docker-ce=5:24.0.6-1~ubuntu.22.04~jammy docker-ce-cli=5:24.0.6-1~ubuntu.22.04~jammy
``` 
...
``` text
Package: docker-ce  
Pin: version 5:24.0.6-1~ubuntu.22.04~jammy-<<YOUR_VERSION_REPLACE_JAMMY>>     
Pin-Priority: 1000  
